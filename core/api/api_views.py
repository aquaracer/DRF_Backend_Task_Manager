...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        tags=['task'],
        operation_description='Cписок задач',
        **TOKENS_PARAMETER,
    ),
)
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        tags=['task'],
        operation_description='Информация об отдельной задаче',
        **TOKENS_PARAMETER,
    ),
)
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        tags=['task'],
        operation_description='Изменение информации о задаче',
        **TOKENS_PARAMETER,
    ),
)
@method_decorator(
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        tags=['subtask'],
        operation_description='Изменение информации о подзадаче',
        **TOKENS_PARAMETER,
    ),
)
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        tags=['subtask'],
        operation_description='Удаление подзадачи',
        **TOKENS_PARAMETER,
    ),
)
