...
class Notification(AbstarctBaseModel):
    ...
    status = models.CharField(verbose_name='Статус', choices=STATUS, max_length=30, default=PLANNED, blank=True)
    ...
    task_result_id = models.UUIDField(
        verbose_name='ID результата выполнения задачи',
        unique=True,
        blank=True,
        null=True,
    )
